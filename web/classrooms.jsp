    ...
    <body>
        ...
        <c:if test="${param.deleteSuccess eq 'true'}">
            <div  class="toast-container position-fixed start-50 translate-middle" style="top: 10%">
                <div class="toast text-bg-success toast-success-animate show">
                    <div class="toast-body">
                        Class deleted/restored successfully!
                    </div>
                </div>
            </div>
        </c:if>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; align-items: center; justify-content: center; ">
                            <form class="search-form" action="classes" method="get" style="display: flex; align-items: center; justify-content: center; margin-right: 5px">
                                <input type="text" class="form-input" placeholder="Search classes..." 
                            ...
                            <tbody>
                                <c:forEach var="classroom" items="${classrooms}">
                                    <tr>
                                        ...
                                        <td class="td-name">${classroom.teacher.fullName}</td>
                                        <td class="td-name">
                                            <fmt:formatNumber value="${classroom.tuitionFee}" pattern="###,###" />
                                        </td>
                                        <td class="td-name">${classroom.maxStudents}</td>
                                        <td class="td-name">
                                        ...
                                        <td class="td-name">
                                            <button type="button" class="btn  btn-small btn-success" data-bs-toggle="modal" data-bs-target="#updateModal_${classroom.id}">
                                                Edit
                                            </button>
                                            <div class="modal fade" id="updateModal_${classroom.id}" tabindex="-1" aria-labelledby="updateModalLabel_${classroom.id}" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" style="max-width: 800px">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="updateModalLabel_${c.id}">Update Class</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form class="add-form" action="classes" method="post">
                                                                ...
                                                                <div class="form-row" style="grid-template-columns: 1fr 1fr; gap:20px;">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Level</label>
                                                                        <select name="levelId" class="form-input" required>

                                                                            <c:forEach var="l" items="${levels}">
                                                                                <option value="${l.id}"
                                                                                        ${l.id == classroom.level.id ? 'selected' : ''}>
                                                                                    ${l.levelName}
                                                                                </option>
                                                                            </c:forEach>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="teacherId" class="form-input" required>
                                                                            ...
                                                                            <c:forEach var="t" items="${teachers}">
                                                                                <option value="${t.id}"
                                                                                        ${t.id == classroom.teacher.id ? 'selected' : ''}>
                                                                                    ${t.fullName}
                                                                                </option>
                                                                            </c:forEach>
                                                                ...
                                                                <div class="form-actions" style="display:flex; justify-content:end; gap:4px;">
                                            ...
                                            <c:if test="${!classroom.isDeleted}">
                                                <button type="button" class="btn  btn-small btn-danger" data-bs-toggle="modal" data-bs-target="#deleteStudentModal_${classroom.id}">
                                                    Delete
                                                </button>
                                            </c:if>

                                            <c:if test="${classroom.isDeleted}">
                                                <button type="button" class="btn  btn-small btn-success"  data-bs-toggle="modal" data-bs-target="#deleteStudentModal_${classroom.id}">
                                                    Restore
                                                </button>
                                            </c:if>

                                            <div class="modal fade" id="deleteStudentModal_${classroom.id}" tabindex="-1" aria-labelledby="deleteStudentModal_${classroom.id}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="deleteStudentModal_${classroom.id}">Delete/Restore Classes</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            ...
                                                            <c:if test="${!classroom.isDeleted}">
                                                                <p class="fs-5 mb-2">
                                                                    ...
                                                                    <span class="fw-bold text-danger">${classroom.id}</span>
                                                                </p>
                                                                <form class="add-form" action="classes" method="post">
                    ...
                    <div class="modal-body">
                        <form class="add-form" action="classes" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label>Max Students</label>
                                    <input type="number" name="maxStudents" class="form-input" min="1">
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label>Tuition Fee</label>
                                    <input type="number" name="tuitionFee" class="form-input" step="0.01">
                                </div>
