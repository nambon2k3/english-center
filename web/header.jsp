<%-- 
    Document   : header.jsp
    Created on : Mar 14, 2026, 10:14:01 PM
    Author     : Legion
--%>
...
<html lang="en">
    <head>
        ...
        <title>Analytics - Englify Admin</title>
            ...
            <div class="nav-container">
                <div class="nav-left">
                    ...
                    <div class="nav-menu">
                        ...
                        <div class="nav-item">
                            <a href="${pageContext.request.contextPath}/classes" class="nav-link ${activePage == 'classes' ? 'active' : ''}">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="nav-item">
                            <a href="${pageContext.request.contextPath}/teachers" class="nav-link ${activePage == 'teachers' ? 'active' : ''}">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="nav-item">
                            <a href="${pageContext.request.contextPath}/students" class="nav-link ${activePage == 'students' ? 'active' : ''}"">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="nav-right">
                    ...
                    <button class="user-menu">
                        <div class="user-avatar">
                            ${fn:substring(fn:toUpperCase(cookie.username.value),0,1)}
                        </div>
                        <span class="user-name">
                            ${fn:substring(fn:toUpperCase(cookie.username.value),0,5)}
                        </span>
                    </button>
