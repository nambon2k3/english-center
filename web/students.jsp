    ...
    <body>
        ...
        <c:if test="${param.deleteSuccess eq 'true'}">
            <div  class="toast-container position-fixed start-50 translate-middle" style="top: 10%">
                <div class="toast text-bg-success toast-success-animate show">
                    <div class="toast-body">
                        Student deleted/restored successfully!
                    </div>
                </div>
            </div>
        </c:if>
        ...
        <c:if test="${param.deleteFail eq 'true'}">
            <div class="toast-container position-fixed start-50 translate-middle" style="top: 10%">
                <div class="toast text-bg-success toast-success-animate show">
                    <div class="toast-body">
                        Student deleted/restored Failed!
                    </div>
                </div>
            </div>
        </c:if>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; align-items: center; justify-content: center; ">
                            <form class="search-form" action="students" method="get" style="display: flex; align-items: center; justify-content: center; margin-right: 5px">
                            ...
                            <tbody>
                                <c:forEach var="student" items="${students}">
                                    <tr>
                                        ...
                                        <td class="td-name">${student.dateOfBirth}</td>
                                        <td class="td-name">${student.phone}</td>
                                        <td class="td-name">${student.email}</td>
                                        <td class="td-name">
                                        ...
                                        <td class="td-name">
                                            <button type="button" class="btn  btn-small btn-success" data-bs-toggle="modal" data-bs-target="#updateModal_${student.id}">
                                                Edit
                                            </button>
                                            <div class="modal fade" id="updateModal_${student.id}" tabindex="-1" aria-labelledby="updateModalLabel_${student.id}" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" style="max-width: 800px">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="updateModalLabel_${student.id}">Update Student</h1>
                                                            ...
                                                            <form class="add-form" action="students" method="post">
                                                                ...
                                                                <div class="form-row"  style="grid-template-columns: 1fr 1fr; gap:20px;"">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="username" class="form-input" value="${student.username}" required>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>Password</label>
                                                                        <input type="password" name="passwordHash" class="form-input" value="${student.passwordHash}" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="fullName" class="form-input" value="${student.fullName}" required>
                                                                    </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input type="email" name="email" class="form-input" required value="${student.email}">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>Phone</label>
                                                                        <input type="text" name="phone" class="form-input" required value="${student.phone}"> 
                                                                    </div>
                                                                </div>
                                            ...
                                            <c:if test="${!student.isDeleted}">
                                                <button type="button" class="btn  btn-small btn-danger" data-bs-toggle="modal" data-bs-target="#deleteStudentModal_${student.id}">
                                                    Delete
                                                </button>
                                            </c:if>

                                            <c:if test="${student.isDeleted}">
                                                <button type="button" class="btn  btn-small btn-success"  data-bs-toggle="modal" data-bs-target="#deleteStudentModal_${student.id}">
                                                    Restore
                                                </button>
                                            </c:if>
                                            <div class="modal fade" id="deleteStudentModal_${student.id}" tabindex="-1" aria-labelledby="deleteStudentModal_${student.id}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="deleteStudentModal_${student.id}">Delete/Restore student</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <c:if test="${!student.isDeleted}">
                                                                <p class="fs-5 mb-2">
                                                                    ...
                                                                    <span class="fw-bold text-danger">${student.id}</span>
                                                                </p>
                                                                <form class="add-form" action="students" method="post">
